...
* `./sql/dql/`: Scripts de consulta e recuperação dos dados. COntém scripts em SQL e PL/SQL.
...
4. Em seguida, execute os scripts de `./sql/dql/sql` e `./sql/dql/pl` para realizar as consultas.